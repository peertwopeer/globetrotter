    ...
    <div class="col-md-7">
      ...
      <div class="p-1">
        <sup
          ...
          title="This will help GUESTs find you better. Give clear and concise instructions such as local transport links and landmarks."
          >Directions <b>?</b></sup
        >
      ...
      <div class="mb-2 p-1">
        <sup
          class="text-primary form-label fs-6"
          title="This may include safety procedures or rules for GUESTs on location. This will appear as small text at the bottom of your invitation."
