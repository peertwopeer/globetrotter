                  ...
                  <div class="row mb-1">
                    <div class="col-md-6 mb-2">
                      <InputField
                        ...
                        :model="visit.GUEST.firstName"
                        @event="visit.GUEST.firstName = $event"
                      />
                    </div>
                    <div class="col-md-6 mb-2">
                      <InputField
                        ...
                        :model="visit.GUEST.lastName"
                        @event="visit.GUEST.lastName = $event"
                      />
                    </div>
                  </div>
                  ...
                  <div class="row mb-1">
                    <div class="col-md-6 mb-2">
                      <InputField
                        ...
                        label="Email Address"
                        :error="errors.email"
                        :model="visit.GUEST.email"
                        @event="visit.GUEST.email = $event"
                      />
                    </div>
                    ...
                    <div class="col-md-6 mb-2">
                      <InputField
                        ...
                        label="Phone Number"
                        :error="errors.phone"
                        :model="visit.GUEST.phone"
                        @event="visit.GUEST.phone = $event"
                      />
                    </div>
                  </div>
                  ...
                  <div class="row mb-2">
                    <div class="col-md-5">
                      <InputField
                        ...
                        :model="visit.GUEST.company"
                        @event="visit.GUEST.company = $event"
                      />
                    </div>
...
export default {
  ...
  methods: {
      ...
      HTTP.post("/api/visit/visit-by-token/", { token })
        .then((response) => {
          ...
          if (visitSlotEnd.isBefore()) {
            ...
            swal({
              text: `${GUESTName} to meet ${responseData.hostName} \nin ${
    ...
    registerVisit() {
      ...
      let formData = (({ host, GUEST, location, dateTo }) => ({
        ...
        organization: toTittleCase(GUEST.company),
        first_name: toTittleCase(GUEST.firstName),
        last_name: toTittleCase(GUEST.lastName),
