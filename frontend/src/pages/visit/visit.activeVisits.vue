        ...
        <div class="row fade_in">
          <div class="col-md-2">
            <blockquote class="blockquote">
              <p class="text-dark lead">GUESTs Overview</p>
            </blockquote>
          </div>
          <div class="col-md-4">
            <div class="row">
          ...
          <div class="col-md-6">
            <div class="d-flex flex-row justify-content-end mt-3">
              <span class="text-dark small lh-1 mt-1 me-1"
                >Only show GUESTs who have passed security check and are
                awaiting host</span
              >
          ...
          <grid-field
            ...
            :rowData="$store.getters.GUESTsCheckedIn"
          />
          <span class="text-dark mt-2"> GUESTs with Host </span>
          <grid-field
            height="30vh"
            :columnDefs="columnDefsCollected"
            :rowData="$store.getters.GUESTsWithHost"
          />
