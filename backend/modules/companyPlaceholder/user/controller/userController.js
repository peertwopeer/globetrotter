...
module.exports = {
  ...
  sendEvacuationNotice: async function (req, res) {
    ...
    try {
      ...
      // GUESTs currently on your premises
      let queryParams = {
        visitStatus: [
      ...
      let GUESTsCheckedIn = await visitModel.visits(queryParams);
      if (GUESTsCheckedIn.length)
        GUESTEmails.push(GUESTsCheckedIn[0]["dataValues"]);
      ...
      if (upcomingVisits.length)
        GUESTEmails.push(upcomingVisits[0]["dataValues"]);
