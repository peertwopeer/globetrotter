                      ...
                      <div class="card-body">
                        ...
                        <div class="form-check mb-3">
                          ...
                          <label class="form-check-label fs-13 font-green">
                            By Signing up to companyPlaceholder MyGUEST you
                            agree to our
                            <a
                              class="link"
                              target="_blank"
                              href="https://s3-eu-west-1.amazonaws.com/static.companyPlaceholder.io/companyPlaceholder/legal/companyPlaceholder_Terms_of_Use_current.pdf"
                              >terms of service</a
                            >
                          </label>
                        </div>
                        <div class="d-md-flex justify-content-md-center mb-3">
                          <a
                            ...
                            href="mailto:help@companyPlaceholder.io?subject=Can I have a MyGUEST account"
                          >
                            Need a hand? Contact us at
                            help@companyPlaceholder.io
                          </a>
                        </div>
                        <div class="d-md-flex justify-content-md-center mb-3">
                          <button
