          ...
          >
            <tbody>
              <tr>
                <td align="left">
                  <img
                    src="https://s3-eu-west-1.amazonaws.com/static.companyPlaceholder.io/companyPlaceholder/img/logos/my_GUEST_logo.png"
                    alt="logo"
                    width="35%"
                  />
                </td>
              ...
              <tr>
                <td
                  ...
                  "
                >
                  <h6 style="margin: 0; font-size: 25px; white-space: nowrap; color: #002a6c">
                    Your slot at ${organization1} has been confirmed
                  </h6>
                </td>
              </tr>
              <tr>
                ...
                >
                  <p style="margin: 0; margin-bottom: 10px; color: #002a6c">
                    <strong>${GUESTName}</strong> to meet
                    <strong>${hostName}</strong> on
                    <strong>${time}</strong> at <strong>${date}</strong> and check in at
                ...
                >
                  <figure style="margin: 0">
                    ...
                    <figcaption style="color: #1b417c">
                      Check-In reference:<strong> ${registrationCode}</strong>
                    </figcaption>
                  </figure>
                </td>
              </tr>
              <tr>
                ...
                >
                  ...
                  <p>We wish you a pleasant visit</p>
                  <p>See you soon,</p>
